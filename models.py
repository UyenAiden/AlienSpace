...
class Alien(GImage):
    ...
    def __init__(self,x,y,source): #these will change
        """
...
class Bolt(GRectangle):
    ...
    #def __init__
    #super().__init__
    #GRectangle(x=GAME_WIDTH//2,y=SHIP_BOTTOM+SHIP_HEIGHT,
                            #width=BOLT_WIDTH,height=BOLT_HEIGHT,
                            #fillcolor = 'yellow',linecolor='navy'),
