...
class Invaders(GameApp):
    ...
    def start(self):
        ...
        self.s = False
        self._wave = None
        self._text = GLabel(text="Press 'S' to Play",font_name="Arcade.ttf",font_size=90)
        self._text.x = self.width//2
        self._text.y = self.height//2
        self._text.fillcolor = 'navy'
        self._text.linecolor = 'gold'
    ...
    def update(self,dt):
        ...
        if self._state == STATE_ACTIVE:
            if self._wave.getStopGame() == True:
    ...
    def _determineState(self):
        ...
        if s == True and self.s == False: #self.s is the previous one
            self._state = STATE_NEWWAVE
            self._text = None
        # Update last_keys
        self.s = s

        #ctrl + / : comment all of the codes
    # def _isNewwave(self):
    #     """
    #     Check if the state is Newwave
    #     """
    #     if self._state == STATE_INACTIVE and self._determineState(and input.is_key_down('n')):
    #         return True
    #
    #
    # def _isPaused(self):
    ...
    #     """
    #     if input.is_key_down('p') == True:
    #         return True
    #
    #
    # def _isContinue(self):
    #     """
    #     Check if the state is Continue
    #     """
    #     if self._state == STATE_PAUSED and input.is_key_down('c'):
    #         return True
    #
    #
